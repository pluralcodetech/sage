...
const MBA = () => {
 ;
  return (
    <div className="cert">
      <h2 className="text-center my-5 text-black" data-aos="zoom-in-up" data-aos-duration="2000">Sage Mini MBA</h2>
      <div  className="row">
        <div className="col-sm-12 col-md-12 col-lg-6" data-aos="fade-right" data-aos-duration="2000">
