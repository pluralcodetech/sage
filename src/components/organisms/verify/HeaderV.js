...
const HeaderV = () => {
  return (
    <div className='row training p-4 p-lg-5 gap-3 justify-content-between align-items-center'>
      <div className='col-sm-12 col-md-12 col-lg-6 p-0 verifyrow' data-aos="zoom-in-up" data-aos-duration="2000">
        <h2 className='verifytext'>Verify <span>Our Student</span><br/>Credentials</h2>
