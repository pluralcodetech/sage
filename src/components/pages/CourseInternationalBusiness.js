...
const CourseInternationalBusiness = () => {
  return (
    <div>
      <HeaderEchC childreneach="International Business"/>
      <AboutC />
      <Benefits/>
      <Video />
      <Learn />
      <div className="px-4 px-lg-5 py-2">
        <Box boxtitle="International Business"/>
      </div>
      <Say />
...
export default CourseInternationalBusiness
